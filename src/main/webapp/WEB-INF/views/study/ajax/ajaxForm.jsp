...
<div class="container">
  ...
  <div>문자값 전달<br/>
    ...
    <a href="${ctp}/study/ajax/ajaxTest4_1" class="btn-btn-primary">응용(배열형식)</a> :
    <a href="${ctp}/study/ajax/ajaxTest4_2" class="btn-btn-secondary">응용(ArrayList)</a> :
    <a href="${ctp}/study/ajax/ajaxTest4_3" class="btn-btn-info">응용(Map)</a> :
    <a href="${ctp}/study/ajax/ajaxTest4_4" class="btn-btn-info">응용(DB자료)</a> :
  </div>
